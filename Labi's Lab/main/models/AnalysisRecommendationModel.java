...
public class AnalysisRecommendationModel extends AbstractTableModel {
	...
	private static ArrayList<Map.Entry<AnalysisType, Double>> analysisRequests;
	...
	public AnalysisRecommendationModel(ArrayList<Map.Entry<AnalysisType, Double>> analysisRequests) {
		AnalysisRecommendationModel.analysisRequests = analysisRequests;
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			return analysisTypeWithResult.getKey().getLowerBound();
		case 3:
			return analysisTypeWithResult.getKey().getUpperBound();
		case 4:
			if (analysisTypeWithResult.getValue() == null) 
				return "processing";
			return analysisTypeWithResult.getValue();
		case 5:
