...
public class MenuTechnicial extends MenuClass {
	...
	public MenuTechnicial() {
		...
		iconRequests.setIcon(new ImageIcon(MenuAdmin.class.getResource("/Interfaces/requestMT.jpg")));
		...
		iconRequest.setIcon(new ImageIcon(MenuAdmin.class.getResource("/Interfaces/sendARequest.jpg")));
