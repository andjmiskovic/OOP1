...
public class MenuAdmin extends MenuClass {
	...
	public MenuAdmin() {
		...
		iconPatientsStatistics.setIcon(new ImageIcon(MenuAdmin.class.getResource("/Interfaces/patientStatistics.jpg")));
		...
		iconIncomes.setIcon(new ImageIcon(MenuAdmin.class.getResource("/Interfaces/incomesNew.jpg")));
		...
		iconOutcomes.setIcon(new ImageIcon(MenuAdmin.class.getResource("/Interfaces/incomes.jpg")));
