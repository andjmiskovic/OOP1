...
public class PanelResultsPatient extends JPanel {
	...
	public static JPanel setUp() {
		...
		icon.setIcon(new ImageIcon(PanelEmployees.class.getResource("/Interfaces/resultsBlue.jpg")));
		...
		changingPanel.add(setUpTable(AllAnalysisRequests.getAnalysisRequestsByPatient(CurrentUser.getCurrentPatient()), 92, 213, 957, 476));
		...
		detailsButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (line == -1) {
					JOptionPane.showMessageDialog(null, "You have to pick 1 request.",
