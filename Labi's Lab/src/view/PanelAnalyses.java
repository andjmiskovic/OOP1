...
import tableModels.AnalysisModel;
...
//			}
//		});
//		delete.setIcon(new ImageIcon(PanelAnalyses.class.getResource("/pictures/trash.jpg")));
...
//		changingPanel.add(delete);
		...
		icon.setIcon(new ImageIcon(PanelEmployees.class.getResource("/pictures/analysisBlue.jpg")));
