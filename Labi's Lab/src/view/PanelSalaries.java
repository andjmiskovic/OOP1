...
public class PanelSalaries extends JPanel {
	...
	public static JPanel setUp() {
		...
		icon.setIcon(new ImageIcon(PanelSalaries.class.getResource("/pictures/walletBlue.jpg")));
		...
		homeVisitPrice.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		JTextField homeVisitWithTimePrice = new JTextField(
				String.valueOf(SalaryCoefficients.salaryCoefficient.getHomeVisitWithTime()));
		homeVisitWithTimePrice.setColumns(7);
		homeVisitWithTimePrice.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		JTextField homeVisitBonus = new JTextField(String.valueOf(SalaryCoefficients.salaryCoefficient.getHomeVisitBonus()));
		homeVisitBonus.setColumns(7);
		homeVisitBonus.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		homeVisitWithTimeBonus.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		specializationBonus.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		holidayBonus.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		otherPanel.add(new Label("processed sample bonus"));
		JTextField processedSample = new JTextField(
				String.valueOf(SalaryCoefficients.salaryCoefficient.getHolidayBonus()));
		processedSample.setColumns(7);
		processedSample.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				char c = e.getKeyChar();
				if (!(((c >= '0') && (c <= '9')) || (c == '.') || (c == KeyEvent.VK_BACK_SPACE)
		...
		otherPanel.add(processedSample, "wrap");
